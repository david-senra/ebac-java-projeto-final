...
import loja.online.usecase.BuscaProduto;
import loja.online.usecase.CadastroProduto;
...
public class ProdutoResource {
	...
	@Operation(summary = "Remove (inativa) um produto pelo seu identificador único")
	...
	@Operation(summary = "Remove (exclui) um produto pelo seu identificador único")
	public ResponseEntity<String> removerSistema(@PathVariable(value = "id") String id) {
		cadastroProduto.removerSistema(id);
		return ResponseEntity.ok("Removido com sucesso");
	}
}